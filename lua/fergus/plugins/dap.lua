...
return {
  ...
  config = function()
    ...
    -- Xcode 26's lldb-dap dropped --port in favor of --connection.
    -- Override the adapter spec installed by xcodebuild.nvim.
    local port = 13000
    dap.adapters["lldb-dap"] = {
      ...
      executable = {
        command = "xcrun",
        args = { "lldb-dap", "--connection", "listen://127.0.0.1:" .. port },
      },
    }
